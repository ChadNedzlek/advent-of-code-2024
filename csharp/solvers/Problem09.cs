...
namespace ChadNedzlek.AdventOfCode.Y2024.CSharp
{
    ...
    {
        public Problem09(string executionMode) : base(executionMode)
        {
        }

        private class ArrayImplProblem09 : DualProblemBase
        {
            public ArrayImplProblem09(string executionMode) : base(executionMode)
            {
            }
        ...
        {
            public RangesImplProblem09(string executionMode) : base(executionMode)
            {
            }
        ...
        {
            var a = new ArrayImplProblem09(ExecutionMode);
            var r = new RangesImplProblem09(ExecutionMode);
